    ...
    try {
      const res = await fetch('/api/buyer-requests', {
        ...
        body: JSON.stringify({
          ...
          city: formData.city,
          locationNotes: formData.location_notes,
          zoning: formData.zoning,
          areaUnit: formData.area_unit,
          minAcreage: formData.min_acreage,
          maxAcreage: formData.max_acreage,
          roadAccess: formData.road_access,
          utilities: formData.utilities,
          minBudget: formData.min_budget,
          maxBudget: formData.max_budget,
          pricePerAcre: formData.price_per_acre,
          financing: formData.financing,
          primaryUseCase: formData.primary_use_case,
          useCaseDescription: formData.use_case_description,
          specificRequirements: formData.specific_requirements,
          targetCloseDate: formData.target_close_date,
          timelineUrgency: formData.timeline_urgency,
          workingWithAgent: formData.working_with_agent,
