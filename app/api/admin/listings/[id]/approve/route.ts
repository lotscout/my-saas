  ...
  try {
    ...
    if (sellerEmail) {
      try {
        ...
        await logEmail({ user_id: listing.user_id, to_email: sellerEmail, from_email: 'hello@lotscout.com', subject: 'Your listing has been approved — LotScout', email_type: 'listing_approved' });
      } catch (emailErr) {
