    ...
    if (sellerEmail) {
      try {
        ...
        await resend.emails.send({
          ...
          to: sellerEmail,
          subject: 'Your listing needs attention — LotScout',
          html: `
            <div style="font-family:sans-serif;max-width:560px;margin:0 auto">
              ...
              <div style="background:#f9fafb;padding:32px;border-radius:0 0 12px 12px;border:1px solid #e5e7eb">
                <h2 style="color:#1B4332;margin-top:0">Your Listing Needs Attention</h2>
                <p>Hi ${sellerName},</p>
                <p>Thank you for submitting your listing. After review, we weren't able to approve it at this time.</p>
                ...
                <p>Please make the necessary changes and resubmit your listing. We'd love to help you get it on the marketplace!</p>
        ...
        await logEmail({ user_id: listing.user_id, to_email: sellerEmail, from_email: 'hello@lotscout.com', subject: 'Your listing needs attention — LotScout', email_type: 'listing_revision' });
      } catch (emailErr) {
