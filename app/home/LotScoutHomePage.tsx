...
const objections = [
  ...
  },
  {
    ...
    body: 'LotScout packages buyer intent, seller context, zoning, utilities, comps, buildability, and market demand so conversations start with confidence instead of guesswork.',
  },
];
