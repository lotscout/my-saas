...
export default function ListingDetailPage() {
  ...
  return (
    <div className="bg-surface text-on-surface">
      ...
      <div className="w-full border-t border-outline-variant/20 bg-surface-container-low px-6 py-5">
        <div className="max-w-7xl mx-auto">
          <p className="text-[11px] font-bold text-secondary uppercase tracking-widest mb-1.5">Disclaimer</p>
